...
api = "7308792898:AAHxjmxQ6bCcNAg68PeBSG3jq5Nodd3BwDM"
bot = Bot(token = api)
...
kb3 = InlineKeyboardMarkup(
    inline_keyboard=[
        [InlineKeyboardButton (text = 'Аквавите', callback_data= 'product_buying'),
         InlineKeyboardButton (text = 'Веритас', callback_data= 'product_buying')],
        [InlineKeyboardButton (text = 'Игналиквид', callback_data= 'product_buying'),
         InlineKeyboardButton (text = 'Байкальская вода', callback_data= 'product_buying')]
    ],
    resize_keyboard = False
)
...
async def get_buying_list(message):
    for i in range (1, 5):
        info_text = f"Название: Product{i} | Описание: описание {i} | Цена: {i*100}"
